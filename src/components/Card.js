...
//   const [value, setValue] = useState(callback()); // Initialize state with initial value
...
//       case 'clear':
//         body.style.backgroundImage = `url(${bgclear})`;
//         console.log(props.main)
//         break;
//       case "clouds":
//         body.style.backgroundImage = `url(${bgclouds})`;
//         break;
//       case "rain":
//         body.style.backgroundImage = `url(${bgrain})`;
//         break;
//       case "haze":
//         body.style.backgroundImage = `url(${bgMHF})`;
//         break;
//       case "mist":
//         body.style.backgroundImage = `url(${bgMHF})`;
//         break;
...
//         break;
//       case "snow":
//         body.style.backgroundImage = `url(${bgsnow})`;
//         break;
//       case "thunderstorm":
//         body.style.backgroundImage = `url(${bgthunderstorm})`;
//         break;
//       case "drizzle":
//         body.style.backgroundImage = `url(${bgdrizzle})`
//         break;
//       default:
//         body.style.backgroundImage = `url(${bgdefault})`;
//         break;
//     } 
